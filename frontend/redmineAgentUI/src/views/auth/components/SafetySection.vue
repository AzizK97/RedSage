      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        <AnimatedSection>
          ...
          <div class="space-y-4 mb-8">
            <h4 class="text-sm font-semibold text-surface-300 uppercase tracking-wider">Protected Operations</h4>
            <div class="grid sm:grid-cols-2 gap-3">
              <div v-for="op in writeOps" :key="op" class="flex items-center gap-2.5 text-sm text-surface-400">
          ...
          <div class="flex items-center gap-3 text-sm text-surface-500">
            ...
            <code class="font-mono text-copper-300">POST /approve/&#123;thread_id&#125;</code>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection :delay="200">
          <div class="glass-card p-6 space-y-4">
            ...
            <div class="rounded-xl bg-surface-900/80 border border-surface-800 p-4 space-y-3">
              ...
              <p class="text-sm text-surface-200">Create issue <span class="font-mono text-copper-300">"Login timeout on mobile"</span> in AI Platform as Bug</p>
            ...
            <div class="flex gap-3 pt-2">
              ...
              <button class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg bg-surface-800 border border-surface-700 text-surface-300 text-sm font-semibold hover:border-red-500/30 hover:text-red-400 transition-colors">
                <ThumbsDown :size="16" /> Reject
              </button>
            </div>

            <div class="rounded-xl bg-surface-900/80 border border-surface-800 p-4 space-y-3 opacity-50">
              <div class="flex items-center justify-between">
                <span class="text-xs font-semibold uppercase tracking-wider text-surface-500">Action</span>
                <span class="text-xs px-2 py-0.5 rounded-full bg-sage-500/10 text-sage-400 border border-sage-500/20">Approved</span>
              </div>
              <p class="text-sm text-surface-200 line-through opacity-60">Reassign issue #156 to Sarah</p>
            </div>
          </div>
        </AnimatedSection>
      </div>
